  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell: "text-500 rounded-md w-9 font-normal text-[0.8rem]",
        ...
        day_selected:
          "bg-gray-800 text-gray-50 hover:bg-gray-900 hover:text-gray-50 focus:bg-gray-900 focus:text-gray-50",
        day_today: "bg-gray-200 text-gray-800",
        day_outside: "text-500 opacity-50",
        day_disabled: "text-500 opacity-50",
